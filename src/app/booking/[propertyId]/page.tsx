        ...
        {!paymentId ? (
          <>
            ...
            <button
              ...
              className="w-full bg-brand-600 hover:bg-brand-700 disabled:bg-stone-200 text-white py-3 rounded-lg font-semibold transition"
            >
      ...
      <div className="space-y-3 no-print">
        {isFailed ? (
          <>
            <button
              onClick={onRetry}
              className="w-full bg-brand-600 hover:bg-brand-700 text-white py-3 rounded-lg font-semibold transition"
            >
              Try Payment Again
            </button>
          ...
          <>
            <button
              onClick={handlePrint}
              className="w-full bg-brand-600 hover:bg-brand-700 text-white py-3 rounded-lg font-semibold transition flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
