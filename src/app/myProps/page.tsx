    ...
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button
            type="button"
            onClick={() => router.push('/myProps/properties/create/draft')}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 transition-colors">
        ...
        {recentProperties.length > 0 ? (
          ...
          <div className="text-center py-8">
            ...
            <Link 
              href="/myProps/properties/create/draft"
              className="inline-flex items-center mt-4 px-4 py-2 bg-brand-600 hover:bg-brand-700 text-white rounded-lg transition-colors text-sm font-medium"
            >
