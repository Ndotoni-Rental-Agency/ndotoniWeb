...
interface SocialAuthButtonsProps {
  onSocialAuth: (provider: 'google' | 'facebook') => Promise<void>;
  loading: boolean;
}
  ...
  return (
    <div className="mb-6">
      <div className="space-y-3">
        ...
        <button
          disabled={true}
          className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium text-gray-400 dark:text-gray-500 bg-gray-100 dark:bg-gray-800 cursor-not-allowed transition-colors"
        >
