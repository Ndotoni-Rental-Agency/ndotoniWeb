  ...
  if (conversations.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center">
        ...
        <h3 className="text-lg font-semibold text-ink-900 dark:text-white mb-2">{t('messages.noConversationsYet')}</h3>
        <p className="text-sm text-ink-500 dark:text-gray-400 max-w-xs">
