  ...
  return (
    <>
      ...
      <button
        ...
        aria-label="Hukupata? Tuambie"
      >
        <MagnifyingGlassIcon className="w-5 h-5" />
        {/* Tooltip — desktop only */}
        <span className="hidden sm:block absolute right-16 bg-gray-900 text-white text-xs px-3 py-1.5 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
          Hukupata? Tuambie
        </span>
      </button>
