      ...
      <div className="bg-brand-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2 bg-white text-brand-600 text-sm font-bold rounded-full hover:bg-brand-50 transition-colors shadow-sm"
          >
