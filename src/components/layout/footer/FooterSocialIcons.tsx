...
const socialLinkClass =
  'h-9 w-9 inline-flex items-center justify-center rounded-full bg-white text-ink-700 hover:text-brand-700 hover:bg-cream-50 dark:bg-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors border border-stone-100 dark:border-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900';
