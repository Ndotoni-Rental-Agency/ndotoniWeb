...
const SCRIPT: ScriptLine[] = [
  ...
  { text: "She moved to Dar es Salaam for university not knowing anyone in the city, so she found an agent through a WhatsApp group.", isBeat: false },
  { text: "He showed her one house — but on move-in day, the keys were to a different one, smaller and in worse shape.", isBeat: false },
