...
import { PropertySearchCardSkeletonGrid } from './PropertySearchSkeleton';
 ...
 */
export default function PropertySearchLoadingWrapper({ 
  isLoading, 
  skeletonCount = 8, 
  children 
  ...
  return (
    <div className="relative">
      ...
      {showSkeleton && (
        ...
        >
          <PropertySearchCardSkeletonGrid count={skeletonCount} />
        </div>
      )}
