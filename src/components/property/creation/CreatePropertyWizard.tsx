                  ...
                  <div
                    className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-xs sm:text-sm font-semibold transition-all duration-300 ${
                      currentStep > step.id
                        ...
                        : currentStep === step.id
                        ? 'bg-brand-600 text-white ring-2 sm:ring-4 ring-brand-600/30'
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 px-3 py-3 sm:px-4 sm:py-4 md:px-6 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 transition-colors">
          ...
          {currentStep < CREATE_PROPERTY_STEPS.length ? (
            <button
              type="button"
              onClick={nextStep}
              className="w-full sm:w-auto px-5 sm:px-6 py-2 sm:py-3 bg-brand-600 hover:bg-brand-700 text-white rounded-full transition-colors text-sm sm:text-base font-medium"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full sm:w-auto px-5 sm:px-6 py-2 sm:py-3 bg-brand-600 hover:bg-brand-700 text-white rounded-full disabled:opacity-50 transition-colors text-sm sm:text-base font-medium"
            >
