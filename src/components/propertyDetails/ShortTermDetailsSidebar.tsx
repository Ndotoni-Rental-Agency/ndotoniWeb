...
export default function ShortTermDetailsSidebar({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 space-y-6 lg:sticky lg:top-24 overflow-visible">
      {/* Price Header */}
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full rounded-lg bg-brand-600 hover:bg-brand-700 disabled:bg-stone-200 disabled:cursor-not-allowed text-white py-3 font-semibold transition"
        >
      ...
      <div className="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-3">
        ...
        {property.host?.whatsappNumber && (
          <button
            ...
            className="w-full rounded-lg bg-brand-600 hover:bg-brand-700 text-white py-3 font-semibold transition flex items-center justify-center gap-2"
          >
