  ...
  return (
    <Link href={href} className={`flex items-center ${iconOnly ? 'justify-center' : 'gap-3'} group ${className}`}>
      <div className="relative">
        ...
        <div className={`${sizes.container} bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 dark:from-emerald-700 dark:via-emerald-800 dark:to-emerald-900 rounded-lg flex items-center justify-center transition-all duration-300 group-hover:scale-105 shadow-lg group-hover:shadow-xl border border-gray-600/20 dark:border-emerald-400/20`}>
      ...
      {!iconOnly && (
        <div className="flex flex-col min-w-0">
          ...
          {showTagline && (
            <span className={`${sizes.tagline} text-emerald-700 dark:text-gray-100 font-medium tracking-wide -mt-0.5`}>
              Find Your Home
            </span>
          )}
        </div>
