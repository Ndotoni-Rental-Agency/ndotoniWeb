...
about: {
  ...
  referPage: {
    hero: {
      ...
      subheadline: 'Tell us about them — we\'ll take it from there.',
      ctaPrimary: 'Refer a landlord',
      chip1: 'TZS 2,000 when they list',
      chip2: 'Paid via M-Pesa',
      chip3: 'Up to 5 referrals',
    ...
    journey: {
      pageTitle: 'Refer a landlord',
      pageSubtitle: 'A quick two-step form. Takes about 3 minutes.',
