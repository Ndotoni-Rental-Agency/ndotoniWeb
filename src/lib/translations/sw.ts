export const sw = {
  ...
  referPage: {
    hero: {
      eyebrow: 'Mpango wa Utambuzi',
      headline: 'Unamjua mwenye nyumba? Pata pesa.',
      subheadline: 'Tuambie kumhusu — sisi tutaendelea.',
      ctaPrimary: 'Mtambulishe mwenye nyumba',
      chip1: 'TZS 2,000 anapotangaza',
      chip2: 'Malipo kupitia M-Pesa',
      chip3: 'Hadi utambuzi 5',
    ...
    quickEarn: {
      ...
      item1Title: 'Anapotangaza mali',
      item1Amount: 'TZS 2,000',
      item2Title: 'Inapokodishwa',
      item2Amount: '10% ya faida yetu',
    },
    journey: {
      pageTitle: 'Mtambulishe mwenye nyumba',
      pageSubtitle: 'Hatua mbili tu. Dakika 3 hivi.',
      step1Label: 'Kukuhusu',
      ...
      idUpload: 'Pakia kitambulisho chako',
    ...
    faq: {
      ...
      faq3Answer:
        'Hadi 5 kwa mtu. Kila mmoja anaweza kukupa TZS 2,000 anapotangaza, pamoja na 10% ya faida yetu mali inapokodishwa kupitia Ndotoni.',
